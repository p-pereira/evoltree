...
tokens = ('NUMBER', 'npwhere', 'idapplication', 'idoperator', 'idaffmanager', 
          'idbrowser', 'city', 'idpartner', 'idcampaign', 'idverticaltype', 
...
def p_p(t) : "idx : idapplication"          ; t[0] = [gen_rnd(0, 11)]
def p_q(t) : "idx : idoperator"             ; t[0] = [gen_rnd(1, 11)]
def p_r(t) : "idx : idaffmanager"           ; t[0] = [gen_rnd(2, 11)]
def p_s(t) : "idx : idbrowser"              ; t[0] = [gen_rnd(3, 11)]
def p_t(t) : "idx : city"                   ; t[0] = [gen_rnd(4, 11)]
def p_u(t) : "idx : idpartner"              ; t[0] = [gen_rnd(5, 11)]
def p_v(t) : "idx : idcampaign"             ; t[0] = [gen_rnd(6, 11)]
def p_w(t) : "idx : idverticaltype"         ; t[0] = [gen_rnd(7, 11)]
def p_x(t) : "idx : regioncontinent"        ; t[0] = [gen_rnd(8, 11)]
def p_y(t) : "idx : country_name"           ; t[0] = [gen_rnd(9, 11)]
def p_z(t) : "idx : accmanager"             ; t[0] = [gen_rnd(10, 11)]
...
<idx>           ::= "'idapplication'" | "'idoperator'" | "'idaffmanager'" | 
                "'idbrowser'" | "'city'" | "'idpartner'" | "'idcampaign'" | 
